		...
		<table class="table table-bordered table-hover bg-white mb-0">
			...
			<tbody>
				...
				@php $total += $pan->prix_unitaire * $pan->quantites @endphp
                  ...
                  <td>  
                <form  action="{{ route('panier.update',$pan->idApp) }}" method="POST" class="form-inline d-inline-block" >
                    @csrf
					@method('post')
				...
				<td>
					...
					<a href="{{ route('panier.delete',$pan->idApp) }}" type="submit" class="btn btn-outline-danger" title="Retirer le produit du panier" >Retirer</a>
